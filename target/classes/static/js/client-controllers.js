angular.module('app.controllers', []).controller('ClientController', function($scope, $state, popupService, $window, Shipwreck) {
...
}).controller('ClientController', function($scope, $stateParams, Shipwreck) {
  $scope.shipwreck = Shipwreck.get({ id: $stateParams.id }); //Get a single shipwreck.Issues a GET to /api/v1/shipwrecks/:id
}).controller('ClientController', function($scope, $state, $stateParams, Shipwreck) {
